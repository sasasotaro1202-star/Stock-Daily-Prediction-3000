...
def main():
    ...
    checks=[
        ...
        ("actions_reliability_watchdog",Path(".github/workflows/actions-reliability-watchdog.yml").exists() and 'cron: "7 * * * *"' in Path(".github/workflows/actions-reliability-watchdog.yml").read_text() and "bounded recovery" in Path(".github/workflows/actions-reliability-watchdog.yml").read_text()),        ("automation_heartbeat",Path(".github/workflows/heartbeat.yml").exists() and 'cron: "17 */6 * * *"' in Path(".github/workflows/heartbeat.yml").read_text()),        ("live_performance_gate","live_performance_gate.py" in Path(".github/workflows/us-close-prediction.yml").read_text() and Path("scripts/live_performance_gate.py").exists()),
