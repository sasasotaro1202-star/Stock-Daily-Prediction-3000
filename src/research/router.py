...
CANDIDATES = {
    Regime.NORMAL: ("blend_hgb_lgbm_regularized_recent", "lightgbm_recent", "lightgbm_regularized_recent", "lightgbm", "lightgbm_regularized", "hgb", "extra_trees", "logistic"),
    Regime.HIGH_VOL: ("blend_hgb_lgbm_regularized_recent", "lightgbm_recent", "lightgbm_regularized_recent", "lightgbm", "lightgbm_regularized", "hgb", "extra_trees", "logistic"),
    Regime.TREND: ("blend_hgb_lgbm_regularized_recent", "lightgbm_recent", "lightgbm_regularized_recent", "lightgbm", "lightgbm_regularized", "hgb", "extra_trees", "logistic"),
...
ASSET_CANDIDATES = {
    ...
    "jp_etf": ("blend_hgb_lgbm_regularized_recent", "lightgbm_recent", "lightgbm_regularized_recent", "lightgbm", "lightgbm_regularized", "hgb", "extra_trees", "logistic"),
    "jp_reit": ("blend_hgb_lgbm_regularized_recent", "lightgbm_recent", "lightgbm_regularized_recent", "lightgbm", "lightgbm_regularized", "hgb", "extra_trees", "logistic"),
    "us_stock": ("blend_hgb_lgbm_regularized_recent", "lightgbm_recent", "lightgbm_regularized_recent", "lightgbm", "lightgbm_regularized", "hgb", "extra_trees", "logistic"),
    "us_etf": ("blend_hgb_lgbm_regularized_recent", "lightgbm_recent", "lightgbm_regularized_recent", "lightgbm", "lightgbm_regularized", "hgb", "extra_trees", "logistic"),
}
