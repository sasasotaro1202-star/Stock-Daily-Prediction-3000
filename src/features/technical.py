...
FEATURE_COLUMNS=[
    ...
    "us10y_level_lag1","dxy_ret_1d_lag1","gold_ret_1d_lag1",
    "oil_ret_1d_lag1","hyg_ret_1d_lag1",
    ...
    "market_median_ret_5d","market_median_ret_20d","residual_momentum_20d",
    "market_median_vol_20d","residual_volatility_20d",
